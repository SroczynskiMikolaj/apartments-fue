    ...
    resources: {
      en: {
        translation: {
            ...
            youtube_author: "The author of the video is",
            Beach_house: "Beach House in Costa Calma is a cozy seaside restaurant. It serves Italian and Mediterranean cuisine — crispy pizzas, a cheese-covered burger, fresh salads, pasta, and light dishes perfect for hot days. This is a relaxed place, ideal for a lunch with an ocean view.",
            Restaurante_Casa_Isaitas: "Restaurante Casa Isaítas in Pájara is located in a historic rural house and offers traditional Canarian cuisine prepared with local ingredients. The menu features the famous cachopo, croquetas, grilled cheese, fresh fish, and 'papas arrugadas' potatoes, with a homemade polvito uruguayo for dessert.",
            El_Invernadero_Restaurante: "El Invernadero Restaurante is an elegant restaurant known for modern Mediterranean cuisine. Dishes are based on fresh fish, seafood, and seasonal products, served in a stylish interior with a calm atmosphere.",
            Restaurante_Rugama: "Restaurante Rugama is an intimate place that values simplicity and local flavors. Though not widely known, it offers typical island dishes — fresh fish, grilled meats, and light homemade appetizers.",
            Caretta_Beach_La_Pared: "Caretta Beach La Pared is a seaside restaurant, perfect for food lovers who enjoy a sunset view. The menu features seafood, grilled fish, salads, and tapas — all served in a relaxed, holiday atmosphere.",
            La_Jaula_de_Oro: "La Jaula de Oro is a Spanish restaurant near Pájara, known for its cozy atmosphere and wide selection of tapas. You can try traditional snacks, fish, meat, and regional dishes served with local wine.",
            Pez_Gordo: "Pez Gordo, which literally means 'fat fish', is inspired by seafood cuisine. The menu features fresh fish, shrimp, calamari, and other seafood prepared in various ways — from grilling to delicate stews.",
            La_Vaca_Azul: "La Vaca Azul is a grill-style restaurant offering excellent steaks, burgers, and meat dishes. You can also find fish and local appetizers, all served in a casual and friendly atmosphere.",
            Olivo_Corso: "Olivo Corso is an elegant Mediterranean restaurant combining traditional flavors with a modern approach. Try the octopus salad, ceviche, tuna, and other seafood dishes prepared with attention to detail.",
            Los_Caracoles: "Los Caracoles is a seaside spot whose name — 'the snails' — refers to traditional Spanish snacks. The menu features seafood, tapas, and dishes made from fresh ingredients straight from the ocean.",
            Restaurante_casa_Victor: "Restaurante Casa Victor is a classic Canarian restaurant serving traditional Spanish dishes — fish, seafood, meats, and a variety of tapas. A place to experience the true taste of the island.",
            Micono: "Micono is a modern, casual restaurant offering Mediterranean-inspired dishes. You can enjoy fresh fish, salads, pasta, and light dishes perfect for an evening meal.",
            diner1950: "Diner1950 is a retro American-style diner where burgers, fries, milkshakes, and classic fast-casual dishes reign supreme. It’s a nostalgic place with a relaxed atmosphere.",
            La_Cofradia: "La Cofradía is a seafood restaurant often run by local fishermen. The menu features fresh fish, shrimp, clams, and dishes prepared in a simple, authentic way.",
            La_Barraca: "La Barraca is a rustic seaside tavern offering simple, tasty dishes — from tapas to grilled fish and meats. An ideal place for lunch after a day at the beach.",
            Snack_Bar_Palmita: "Snack Bar Palmita is a small bar serving quick and tasty snacks. The menu includes sandwiches, toasts, tapas, seafood, fish, fresh juices, and light salads — perfect for a short midday stop.",
            Restaurante_Al_Fresco: "Restaurante Al Fresco is designed for outdoor dining. It serves light Mediterranean dishes — fish, seafood, pasta, and salads — in a relaxing open-air atmosphere.",
            Leos: "Leo’s is a cozy, international restaurant where you can enjoy both Spanish and European dishes. A great spot for a casual lunch or dinner with wine.",
            El_Gallego_Luis: "El Gallego Luis is inspired by Galician cuisine, famous for seafood dishes. The menu features Galician-style octopus, fresh fish, clams, and classic Spanish appetizers.",
            Restaurante_Marabu: "Restaurante Marabú is an elegant venue known for combining local and international cuisine. It offers seasonal dishes with fish, meat, and vegetables, along with exquisite desserts and a wide selection of wines.",
            Casa_Naturaleza: "Casa Naturaleza is a peaceful restaurant surrounded by nature. It focuses on healthy, eco-friendly cuisine with local ingredients, offering vegetarian dishes, salads, vegetable meals, and natural juices.",
            Restaurante_La_Jaira: "Restaurante La Jaira de Demian in Puerto del Rosario is a gastro-bar where Canarian cuisine meets modern and seasonal local ingredients. The chef creates dishes full of textures and colors — for example, beet and Majorero cheese gyoza or baked cheese with palm honey. The interior is elegant, with a large dining room and terrace, and the staff encourages sharing plates and enjoying the island’s gastronomy together.",
            Cafe_Caveto: "Café Caveto in La Pared is a cozy café-bistro with a calm atmosphere, perfect for breakfast, brunch, or a light lunch. The menu includes homemade cakes, granola, sandwiches, and freshly squeezed juices — all highly rated by visitors. Ideal for post-surfing or relaxing by the sea.",
            Lumos: "Lumos in Corralejo is a stylish restaurant combining Italian and Mediterranean flavors with a modern touch. Located at Calle Hernán Cortés 6, it offers panzerotti, pizza, and dishes with vegan and vegetarian options. The interior is inviting, and there is also a terrace area — perfect for a calm yet trendy dinner.",
            Restaurants_description_1: "Restaurants in Fuerteventura offer a variety that will satisfy every foodie. In the north, you’ll find modern gastro-bars and fusion cuisine, in the center — family-run restaurants serving homemade food, and in the south — atmospheric beach bars where fresh fish and seafood dominate. Local products such as Majorero cheese, freshly caught fish, olive oil, sun-ripened tomatoes, and aromatic herbs form the foundation of a cuisine that balances simplicity with depth of flavor.",
            Restaurants_description_2: "In Fuerteventura, food is more than just nourishment — it’s a true ritual, a meeting with nature, culture, and people. Many places prepare dishes following traditional recipes passed down through generations, while others surprise with modern approaches and creative presentation. Whether you choose an elegant dinner with wine, tapas with friends at sunset, or a morning coffee with an ocean view — every meal on this island tastes unique.",
            Food_all: "All",
            Food_fish: "Fish",
            Food_sea: "Seafood",
            Food_meat: "Meat",
            ...
            Food_weg: "Vegetarian",
            Food_pizza: "Pizza",
            Gastrobar_El_Pirata_Verde: "Gastrobar El Pirata Verde is a relaxed and modern gastrobar in Fuerteventura with a creative, laid-back vibe. It offers a fusion of local and international flavors, featuring fresh seafood, gourmet burgers, tapas, and vegetarian-friendly options, complemented by craft cocktails and a carefully selected drinks menu.",
      ...
      pl: {
        translation: {
            ...
            youtube_author: "Autorem filmu jest",
            Beach_house: "Beach House w Costa Calma to przytulna restauracja położona tuż przy plaży. Serwuje kuchnię włoską i śródziemnomorską – chrupiące pizze, burgera oblanego serem, świeże sałatki, makarony oraz lekkie dania idealne na gorące dni. To miejsce z luźną atmosferą, doskonałe na obiad z widokiem na ocean.",
            Restaurante_Casa_Isaitas: "Restaurante Casa Isaítas w Pájara mieści się w zabytkowym domu wiejskim i oferuje tradycyjną kuchnię kanaryjską przygotowywaną z lokalnych składników. W menu można znaleźć słynne cachopo, croquetas, grillowany ser, świeże ryby oraz ziemniaki 'papas arrugadas', a na deser domowy polvito uruguayo.",
            El_Invernadero_Restaurante: "El Invernadero Restaurante to elegancka restauracja znana z nowoczesnej kuchni śródziemnomorskiej. Dania oparte są na świeżych rybach, owocach morza i sezonowych produktach, a całość podawana jest w stylowym wnętrzu i w spokojnej atmosferze.",
            Restaurante_Rugama: "Restaurante Rugama to kameralne miejsce, które ceni prostotę i lokalne smaki. Choć mało znane, oferuje dania typowe dla wyspy – świeże ryby, grillowane mięsa i lekkie przystawki w domowym stylu.",
            Caretta_Beach_La_Pared: "Caretta Beach La Pared to restauracja położona nad samym morzem, idealna dla miłośników jedzenia z widokiem na zachód słońca. W menu dominują owoce morza, grillowane ryby, sałatki i tapas – wszystko w luźnym, wakacyjnym klimacie.",
            La_Jaula_de_Oro: "La Jaula de Oro to hiszpańska restauracja w okolicy Pájary, znana z przytulnej atmosfery i bogatego wyboru tapas. Można tu spróbować tradycyjnych przekąsek, ryb, mięs i dań regionalnych serwowanych w towarzystwie lokalnego wina.",
            Pez_Gordo: "Pez Gordo, co dosłownie oznacza 'gruba ryba', to miejsce inspirowane kuchnią morską. W menu dominują świeże ryby, krewetki, kalmary i inne owoce morza przygotowywane na różne sposoby – od grillowania po delikatne potrawki.",
            La_Vaca_Azul: "La Vaca Azul to restauracja o charakterze grillowym, oferująca wyśmienite steki, burgery i dania mięsne. W menu można też znaleźć ryby i lokalne przekąski, a całość podawana jest w swobodnej, przyjaznej atmosferze.",
            Olivo_Corso: "Olivo Corso to elegancka restauracja śródziemnomorska, która łączy tradycyjne smaki z nowoczesnym podejściem do kuchni. Warto spróbować sałatki z ośmiornicy, ceviche, tuńczyka oraz innych dań z owoców morza przygotowanych z dbałością o detale.",
            Los_Caracoles: "Los Caracoles to lokal o morskiej duszy, którego nazwa – 'ślimaki' – nawiązuje do tradycyjnych hiszpańskich przekąsek. W menu dominują owoce morza, tapas i potrawy bazujące na świeżych składnikach prosto z oceanu.",
            Restaurante_casa_Victor: "Restaurante Casa Victor to klasyczna kanaryjska restauracja serwująca tradycyjne dania hiszpańskie – ryby, owoce morza, mięsa i różnorodne tapas. To miejsce, w którym można poczuć prawdziwy smak wyspy.",
            Micono: "Micono to nowoczesna restauracja o luźnym charakterze, oferująca dania inspirowane kuchnią śródziemnomorską. Można tu spróbować świeżych ryb, sałatek, makaronów i lekkich dań idealnych na wieczorny posiłek.",
            diner1950: "Diner1950 to restauracja w stylu amerykańskiego retro baru, gdzie królują burgery, frytki, milkshake’i i klasyczne dania typu fast-casual. To miejsce z nostalgicznym klimatem i swobodną atmosferą.",
            La_Cofradia: "La Cofradía to restauracja o morskim charakterze, często prowadzona przez lokalnych rybaków. W menu królują świeże ryby, krewetki, małże i dania przyrządzane na prosty, autentyczny sposób.",
            La_Barraca: "La Barraca to rustykalna tawerna w stylu nadmorskim, oferująca proste, smaczne potrawy – od tapas po grillowane ryby i mięsa. To idealne miejsce na obiad po dniu spędzonym na plaży.",
            Snack_Bar_Palmita: "Snack Bar Palmita to niewielki bar serwujący szybkie i smaczne przekąski. W menu znajdują się kanapki, tosty, tapas, owoce morze, ryby, świeże soki i lekkie sałatki – idealne na krótki przystanek w ciągu dnia.",
            Restaurante_Al_Fresco: "Restaurante Al Fresco to miejsce stworzone z myślą o posiłkach na świeżym powietrzu. Serwuje lekkie dania śródziemnomorskie – ryby, owoce morza, makarony i sałatki – w relaksującej atmosferze pod gołym niebem.",
            Leos: "Leo’s to przytulna restauracja o międzynarodowym charakterze, w której można zjeść zarówno dania kuchni hiszpańskiej, jak i europejskiej. To dobre miejsce na luźny obiad lub kolację przy winie.",
            El_Gallego_Luis: "El Gallego Luis to restauracja inspirowana kuchnią galicyjską, słynącą z dań z owoców morza. W menu można znaleźć ośmiornicę po galicyjsku, świeże ryby, małże i klasyczne hiszpańskie przystawki.",
            Restaurante_Marabu: "Restaurante Marabú to eleganckie miejsce znane z połączenia kuchni lokalnej z międzynarodową. Oferuje sezonowe potrawy z ryb, mięs i warzyw, a także wykwintne desery i szeroki wybór win.",
            Casa_Naturaleza: "Casa Naturaleza to spokojna restauracja położona w otoczeniu przyrody. Skupia się na zdrowej, ekologicznej kuchni z lokalnych składników, oferując potrawy wegetariańskie, sałatki, dania warzywne i naturalne soki.",
            Restaurante_La_Jaira: "Restaurante La Jaira de Demian w Puerto del Rosario to gastro-bar, w którym kuchnia kanaryjska łączy się z nowoczesnym podejściem i sezonowymi, lokalnymi składnikami. Szef kuchni kreuje dania pełne tekstur i kolorów — przykładem może być gyoza z burakiem i serem majorero lub zapieczony ser w miodze palmowym. Wnętrze jest eleganckie, z dużą salą i tarasem, a obsługa zachęca do dzielenia się talerzami i wspólnego delektowania gastronomią wyspy.",
            Cafe_Caveto: "Café Caveto w La Pared to kameralna kawiarnia-bistro z przyjemną, spokojną atmosferą, idealna na śniadanie, brunch lub lekki lunch. W jej menu znajdziemy własnoręcznie pieczone ciasta, granolę, kanapki, świeżo wyciskane soki — i wszystko bardzo pozytywnie oceniane przez gości. Miejsce to sprawdzi się zarówno po porannym surfingu, jak i przy relaksie nad morzem.",
            Lumos: "Lumos w Corralejo to stylowa restauracja łącząca włoskie i śródziemnomorskie smaki z nowoczesnym podejściem. Znajduje się na ulicy Calle Hernán Cortés 6 i oferuje m.in. panzerotti, pizzę czy dania z opcjami wegańskimi i wegetariańskimi. Wnętrze jest przyjazne, a także dostępna jest część na tarasie — idealna na kolację w spokojnym, lecz modnym otoczeniu.",
            Restaurants_description_1: "Restauracje na Fuerteventurze oferują różnorodność, która zadowoli każdego smakosza. Na północy wyspy znajdziesz nowoczesne gastro-bary i kuchnię fusion, w centralnej części — rodzinne restauracje z domowym jedzeniem, a na południu — klimatyczne beach bary, w których królują świeże ryby i owoce morza. Lokalne produkty, takie jak ser majorero, świeżo złowione ryby, oliwa z oliwek, pomidory dojrzewające w słońcu i aromatyczne zioła, tworzą podstawę kuchni, która łączy prostotę z głębią smaku.",
            Restaurants_description_2: "Na Fuerteventurze jedzenie to nie tylko sposób na zaspokojenie głodu, ale prawdziwy rytuał — spotkanie z naturą, kulturą i ludźmi. W wielu miejscach potrawy przygotowywane są według tradycyjnych przepisów przekazywanych z pokolenia na pokolenie, a w innych zaskakują nowoczesnym podejściem i kreatywną prezentacją. Niezależnie od tego, czy wybierzesz elegancką kolację przy winie, tapas z przyjaciółmi o zachodzie słońca, czy poranną kawę z widokiem na ocean — na tej wyspie każdy posiłek smakuje wyjątkowo.",
            Food_all: "Wszystkie",
            Food_fish: "Ryby",
            Food_sea: "Owoce morza",
            Food_meat: "Mięsa",
            Food_local: "Lokalna",
            Food_weg: "Wegetariańska",
            Food_pizza: "Pizza",
            Gastrobar_El_Pirata_Verde: "Gastrobar El Pirata Verde to nowoczesny i swobodny gastrobar na Fuerteventurze z kreatywną, luźną atmosferą. Oferuje połączenie lokalnych i międzynarodowych smaków, w tym świeże owoce morza, burgery gourmet, tapas oraz opcje przyjazne wegetarianom, uzupełnione autorskimi koktajlami i starannie dobraną kartą napojów.",
      ...
      de: {
        translation: {
            ...
            youtube_author: "Der Autor des Videos ist",
            Beach_house: "Beach House in Costa Calma ist ein gemütliches Restaurant direkt am Strand. Es serviert italienische und mediterrane Küche – knusprige Pizzen, einen mit Käse überbackenen Burger, frische Salate, Pasta und leichte Gerichte, perfekt für heiße Tage. Ein entspannter Ort, ideal für ein Mittagessen mit Blick auf den Ozean.",
            Restaurante_Casa_Isaitas: "Restaurante Casa Isaítas in Pájara befindet sich in einem historischen Landhaus und bietet traditionelle kanarische Küche mit lokalen Zutaten. Auf der Speisekarte stehen das berühmte Cachopo, Croquetas, gegrillter Käse, frischer Fisch und 'papas arrugadas'. Zum Dessert gibt es hausgemachtes polvito uruguayo.",
            El_Invernadero_Restaurante: "El Invernadero Restaurante ist ein elegantes Restaurant, bekannt für moderne mediterrane Küche. Die Gerichte basieren auf frischem Fisch, Meeresfrüchten und saisonalen Produkten und werden in stilvollem Ambiente mit entspannter Atmosphäre serviert.",
            Restaurante_Rugama: "Restaurante Rugama ist ein gemütlicher Ort, der Einfachheit und lokale Aromen schätzt. Obwohl wenig bekannt, bietet es typische Inselgerichte – frischer Fisch, gegrilltes Fleisch und leichte hausgemachte Vorspeisen.",
            Caretta_Beach_La_Pared: "Caretta Beach La Pared ist ein Restaurant direkt am Meer, ideal für Liebhaber von Speisen mit Sonnenuntergangsblick. Auf der Speisekarte dominieren Meeresfrüchte, gegrillter Fisch, Salate und Tapas – alles in entspannter, sommerlicher Atmosphäre.",
            La_Jaula_de_Oro: "La Jaula de Oro ist ein spanisches Restaurant in der Nähe von Pájara, bekannt für seine gemütliche Atmosphäre und große Tapas-Auswahl. Hier kann man traditionelle Snacks, Fisch, Fleisch und regionale Gerichte mit lokalem Wein genießen.",
            Pez_Gordo: "Pez Gordo, wörtlich 'dicker Fisch', ist ein von der Meeresküche inspizierter Ort. Auf der Speisekarte stehen frischer Fisch, Garnelen, Tintenfisch und andere Meeresfrüchte, zubereitet auf verschiedene Arten – vom Grillen bis zu sanften Eintöpfen.",
            La_Vaca_Azul: "La Vaca Azul ist ein Grillrestaurant mit exzellenten Steaks, Burgern und Fleischgerichten. Auf der Speisekarte findet man auch Fisch und lokale Vorspeisen, serviert in einer lockeren, freundlichen Atmosphäre.",
            Olivo_Corso: "Olivo Corso ist ein elegantes mediterranes Restaurant, das traditionelle Aromen mit modernem Küchenansatz kombiniert. Probieren Sie den Oktopussalat, Ceviche, Thunfisch und andere Meeresfrüchte, sorgfältig zubereitet.",
            Los_Caracoles: "Los Caracoles ist ein Ort mit maritimem Flair, dessen Name – 'die Schnecken' – auf traditionelle spanische Snacks verweist. Auf der Speisekarte stehen Meeresfrüchte, Tapas und Gerichte aus frischen Zutaten direkt aus dem Meer.",
            Restaurante_casa_Victor: "Restaurante Casa Victor ist ein klassisches kanarisches Restaurant mit traditionellen spanischen Gerichten – Fisch, Meeresfrüchte, Fleisch und verschiedene Tapas. Ein Ort, um den echten Geschmack der Insel zu erleben.",
            Micono: "Micono ist ein modernes, lässiges Restaurant mit mediterranen Gerichten. Frischer Fisch, Salate, Pasta und leichte Gerichte für das Abendessen stehen auf der Karte.",
            diner1950: "Diner1950 ist ein amerikanisches Retro-Diner, in dem Burger, Pommes, Milchshakes und klassische Fast-Casual-Gerichte dominieren. Ein nostalgischer Ort mit entspannter Atmosphäre.",
            La_Cofradia: "La Cofradía ist ein maritimes Restaurant, oft von lokalen Fischern geführt. Auf der Speisekarte stehen frischer Fisch, Garnelen, Muscheln und Gerichte, die einfach und authentisch zubereitet werden.",
            La_Barraca: "La Barraca ist eine rustikale Strandtaverne mit einfachen, leckeren Gerichten – von Tapas bis gegrilltem Fisch und Fleisch. Perfekt für ein Mittagessen nach einem Tag am Strand.",
            Snack_Bar_Palmita: "Snack Bar Palmita ist eine kleine Bar mit schnellen und leckeren Snacks. Auf der Speisekarte stehen Sandwiches, Toasts, Tapas, Meeresfrüchte, Fisch, frische Säfte und leichte Salate – ideal für einen kurzen Stopp während des Tages.",
            Restaurante_Al_Fresco: "Restaurante Al Fresco ist für Mahlzeiten im Freien konzipiert. Es serviert leichte mediterrane Gerichte – Fisch, Meeresfrüchte, Pasta und Salate – in entspannter Open-Air-Atmosphäre.",
            Leos: "Leo’s ist ein gemütliches, internationales Restaurant, in dem man sowohl spanische als auch europäische Gerichte genießen kann. Ein guter Ort für ein lockeres Mittagessen oder Abendessen mit Wein.",
            El_Gallego_Luis: "El Gallego Luis ist von der galizischen Küche inspiriert, bekannt für Meeresfrüchtegerichte. Auf der Speisekarte stehen galizischer Oktopus, frischer Fisch, Muscheln und klassische spanische Vorspeisen.",
            Restaurante_Marabu: "Restaurante Marabú ist ein eleganter Ort, bekannt für die Kombination lokaler und internationaler Küche. Saisonale Gerichte mit Fisch, Fleisch und Gemüse, exquisite Desserts und eine große Weinauswahl werden angeboten.",
            Casa_Naturaleza: "Casa Naturaleza ist ein ruhiges Restaurant inmitten der Natur. Es legt Wert auf gesunde, ökologische Küche mit lokalen Zutaten und bietet vegetarische Gerichte, Salate, Gemüsegerichte und natürliche Säfte an.",
            Restaurante_La_Jaira: "Restaurante La Jaira de Demian in Puerto del Rosario ist eine Gastro-Bar, in der kanarische Küche auf moderne, saisonale lokale Zutaten trifft. Der Küchenchef kreiert Gerichte voller Texturen und Farben – z. B. Gyoza mit Roter Bete und Majorero-Käse oder gebackener Käse mit Palmhonig. Das Interieur ist elegant mit großem Speisesaal und Terrasse, das Personal fördert das Teilen von Gerichten und das gemeinsame Genießen der Inselküche.",
            Cafe_Caveto: "Café Caveto in La Pared ist ein gemütliches Café-Bistro mit ruhiger Atmosphäre, ideal für Frühstück, Brunch oder leichtes Mittagessen. Auf der Karte stehen hausgemachte Kuchen, Granola, Sandwiches und frisch gepresste Säfte – alles sehr gut von Gästen bewertet. Perfekt nach dem Surfen oder zum Entspannen am Meer.",
            Lumos: "Lumos in Corralejo ist ein stilvolles Restaurant, das italienische und mediterrane Küche mit modernem Ansatz kombiniert. Gelegen in der Calle Hernán Cortés 6, werden Panzerotti, Pizza und Gerichte mit veganen und vegetarischen Optionen angeboten. Das Interieur ist einladend, mit Terrasse – ideal für ein ruhiges, aber trendiges Abendessen.",
            Restaurants_description_1: "Die Restaurants auf Fuerteventura bieten eine Vielfalt, die jeden Feinschmecker zufriedenstellt. Im Norden finden Sie moderne Gastro-Bars und Fusionsküche, im Zentrum familiengeführte Restaurants mit hausgemachten Speisen und im Süden stimmungsvolle Strandbars, in denen frischer Fisch und Meeresfrüchte dominieren. Lokale Produkte wie Majorero-Käse, frisch gefangener Fisch, Olivenöl, sonnenverwöhnte Tomaten und aromatische Kräuter bilden die Basis einer Küche, die Einfachheit mit Geschmackstiefe verbindet.",
            Restaurants_description_2: "Auf Fuerteventura ist Essen mehr als nur Nahrung – es ist ein echtes Ritual, ein Treffen mit Natur, Kultur und Menschen. Viele Orte bereiten Gerichte nach traditionellen Rezepten zu, die von Generation zu Generation weitergegeben werden, während andere mit modernen Ansätzen und kreativer Präsentation überraschen. Ob Sie ein elegantes Abendessen mit Wein, Tapas mit Freunden bei Sonnenuntergang oder einen Morgenkaffee mit Meerblick wählen – jede Mahlzeit auf dieser Insel schmeckt einzigartig.",
            Food_all: "Alle",
            Food_fish: "Fisch",
            Food_sea: "Meeresfrüchte",
            Food_meat: "Fleisch",
            Food_local: "Lokal",
            Food_weg: "Vegetarisch",
            Food_pizza: "Pizza",
            Gastrobar_El_Pirata_Verde: "Gastrobar El Pirata Verde ist eine entspannte und moderne Gastrobar auf Fuerteventura mit kreativer und lockerer Atmosphäre. Sie bietet eine Fusion aus lokalen und internationalen Aromen, darunter frische Meeresfrüchte, Gourmet-Burger, Tapas sowie vegetarische Optionen, ergänzt durch Craft-Cocktails und eine sorgfältig ausgewählte Getränkekarte.",
            Restaurants: "Restaurants",
          },
      },
      es: {
        translation: {
            ...
            youtube_author: "El autor del vídeo es",
            Beach_house: "Beach House en Costa Calma es un acogedor restaurante justo en la playa. Sirve cocina italiana y mediterránea: pizzas crujientes, hamburguesa con queso, ensaladas frescas, pastas y platos ligeros ideales para días calurosos. Un lugar relajado, perfecto para almorzar con vistas al océano.",
            Restaurante_Casa_Isaitas: "Restaurante Casa Isaítas en Pájara se encuentra en una casa rural histórica y ofrece cocina canaria tradicional con ingredientes locales. En el menú se encuentran el famoso cachopo, croquetas, queso a la parrilla, pescado fresco y 'papas arrugadas'. Para el postre, polvito uruguayo casero.",
            El_Invernadero_Restaurante: "El Invernadero Restaurante es un elegante restaurante conocido por su cocina mediterránea moderna. Los platos se basan en pescado fresco, mariscos y productos de temporada, servidos en un ambiente estiloso y tranquilo.",
            Restaurante_Rugama: "Restaurante Rugama es un lugar acogedor que valora la sencillez y los sabores locales. Aunque poco conocido, ofrece platos típicos de la isla: pescado fresco, carnes a la parrilla y aperitivos ligeros caseros.",
            Caretta_Beach_La_Pared: "Caretta Beach La Pared es un restaurante junto al mar, ideal para los amantes de la comida con vistas al atardecer. El menú se centra en mariscos, pescado a la parrilla, ensaladas y tapas, todo en un ambiente relajado y veraniego.",
            La_Jaula_de_Oro: "La Jaula de Oro es un restaurante español cerca de Pájara, conocido por su ambiente acogedor y amplia selección de tapas. Aquí se pueden probar aperitivos tradicionales, pescado, carne y platos regionales acompañados de vino local.",
            Pez_Gordo: "Pez Gordo, que literalmente significa 'pez gordo', es un lugar inspirado en la cocina marina. El menú incluye pescado fresco, camarones, calamares y otros mariscos preparados de diversas formas, desde a la parrilla hasta guisos suaves.",
            La_Vaca_Azul: "La Vaca Azul es un restaurante de estilo parrilla que ofrece excelentes filetes, hamburguesas y platos de carne. También hay pescado y aperitivos locales, todo servido en un ambiente relajado y amigable.",
            Olivo_Corso: "Olivo Corso es un elegante restaurante mediterráneo que combina sabores tradicionales con un enfoque moderno. Vale la pena probar ensalada de pulpo, ceviche, atún y otros platos de mariscos preparados con atención al detalle.",
            Los_Caracoles: "Los Caracoles es un lugar con espíritu marítimo, cuyo nombre – 'los caracoles' – hace referencia a aperitivos tradicionales españoles. El menú incluye mariscos, tapas y platos elaborados con ingredientes frescos directamente del mar.",
            Restaurante_casa_Victor: "Restaurante Casa Victor es un restaurante canario clásico que sirve platos tradicionales españoles: pescado, mariscos, carne y diversas tapas. Un lugar para experimentar el verdadero sabor de la isla.",
            Micono: "Micono es un restaurante moderno y relajado que ofrece platos inspirados en la cocina mediterránea. Se pueden probar pescado fresco, ensaladas, pastas y platos ligeros ideales para la cena.",
            diner1950: "Diner1950 es un restaurante estilo retro americano, donde predominan hamburguesas, papas fritas, batidos y platos clásicos de comida rápida casual. Un lugar con ambiente nostálgico y relajado.",
            La_Cofradia: "La Cofradía es un restaurante de carácter marítimo, a menudo dirigido por pescadores locales. El menú se centra en pescado fresco, camarones, mejillones y platos preparados de manera sencilla y auténtica.",
            La_Barraca: "La Barraca es una taberna rústica junto al mar que ofrece platos simples y sabrosos, desde tapas hasta pescado y carne a la parrilla. Un lugar ideal para almorzar después de un día en la playa.",
            Snack_Bar_Palmita: "Snack Bar Palmita es un pequeño bar que sirve bocadillos rápidos y sabrosos. En el menú hay sándwiches, tostadas, tapas, mariscos, pescado, jugos frescos y ensaladas ligeras, perfecto para una parada rápida durante el día.",
            Restaurante_Al_Fresco: "Restaurante Al Fresco está diseñado para comer al aire libre. Sirve platos mediterráneos ligeros: pescado, mariscos, pastas y ensaladas, en un ambiente relajante al aire libre.",
            Leos: "Leo’s es un restaurante acogedor e internacional, donde se pueden disfrutar platos tanto de cocina española como europea. Un buen lugar para un almuerzo relajado o cena con vino.",
            El_Gallego_Luis: "El Gallego Luis es un restaurante inspirado en la cocina gallega, conocido por sus platos de mariscos. En el menú se encuentran pulpo a la gallega, pescado fresco, mejillones y aperitivos españoles clásicos.",
            Restaurante_Marabu: "Restaurante Marabú es un lugar elegante conocido por combinar cocina local e internacional. Ofrece platos de temporada con pescado, carne y verduras, además de postres exquisitos y una amplia selección de vinos.",
            Casa_Naturaleza: "Casa Naturaleza es un restaurante tranquilo rodeado de naturaleza. Se enfoca en cocina saludable y ecológica con ingredientes locales, ofreciendo platos vegetarianos, ensaladas, platos de verduras y jugos naturales.",
            Restaurante_La_Jaira: "Restaurante La Jaira de Demian en Puerto del Rosario es un gastro-bar donde la cocina canaria se combina con ingredientes locales y de temporada de manera moderna. El chef crea platos llenos de texturas y colores, como gyoza de remolacha y queso majorero o queso horneado en miel de palma. El interior es elegante, con un gran comedor y terraza; el personal fomenta compartir platos y disfrutar juntos de la gastronomía de la isla.",
            Cafe_Caveto: "Café Caveto en La Pared es un café-bistró acogedor con ambiente tranquilo, ideal para desayuno, brunch o almuerzo ligero. El menú incluye pasteles caseros, granola, sándwiches y jugos recién exprimidos, todo muy bien valorado por los clientes. Perfecto después del surf matutino o para relajarse junto al mar.",
            Lumos: "Lumos en Corralejo es un restaurante elegante que combina sabores italianos y mediterráneos con un enfoque moderno. Situado en la Calle Hernán Cortés 6, ofrece panzerotti, pizza y platos con opciones veganas y vegetarianas. El interior es acogedor, con terraza, ideal para una cena tranquila pero a la moda.",
            Restaurants_description_1: "Los restaurantes en Fuerteventura ofrecen una variedad que satisface a cualquier amante de la gastronomía. En el norte encontrarás gastro-bares modernos y cocina fusión, en el centro restaurantes familiares con comida casera y en el sur bares de playa con encanto donde predominan el pescado fresco y los mariscos. Productos locales como queso majorero, pescado recién capturado, aceite de oliva, tomates maduros al sol y hierbas aromáticas forman la base de una cocina que combina simplicidad con profundidad de sabor.",
            Restaurants_description_2: "En Fuerteventura, comer no es solo satisfacer el hambre, sino un verdadero ritual: un encuentro con la naturaleza, la cultura y la gente. En muchos lugares los platos se preparan según recetas tradicionales transmitidas de generación en generación, mientras que en otros sorprenden con un enfoque moderno y presentación creativa. Ya sea que elijas una cena elegante con vino, tapas con amigos al atardecer o un café matutino con vista al mar, cada comida en esta isla es única.",
            Food_all: "Todos",
            Food_fish: "Pescado",
            Food_sea: "Mariscos",
            Food_meat: "Carne",
            Food_local: "Local",
            Food_weg: "Vegetariano",
            Food_pizza: "Pizza",
            Gastrobar_El_Pirata_Verde: "Gastrobar El Pirata Verde es un gastrobar moderno y relajado en Fuerteventura con un ambiente creativo y desenfadado. Ofrece una fusión de sabores locales e internacionales, con mariscos frescos, hamburguesas gourmet, tapas y opciones vegetarianas, acompañadas de cócteles artesanales y una cuidada selección de bebidas.",
      ...
      it: {
        translation: {
          ...
          youtube_author: "L'autore del video è",
          Beach_house: "Beach House a Costa Calma è un accogliente ristorante situato proprio sulla spiaggia. Serve cucina italiana e mediterranea: pizze croccanti, hamburger con formaggio, insalate fresche, pasta e piatti leggeri ideali per giornate calde. Un luogo rilassato, perfetto per pranzare con vista sull'oceano.",
          Restaurante_Casa_Isaitas: "Restaurante Casa Isaítas a Pájara si trova in una storica casa rurale e offre cucina tradizionale delle Canarie con ingredienti locali. Nel menu ci sono i famosi cachopo, croquetas, formaggio alla griglia, pesce fresco e 'papas arrugadas'. Per dessert, polvito uruguayo fatto in casa.",
          El_Invernadero_Restaurante: "El Invernadero Restaurante è un elegante ristorante noto per la sua cucina mediterranea moderna. I piatti sono a base di pesce fresco, frutti di mare e prodotti stagionali, serviti in un ambiente elegante e tranquillo.",
          Restaurante_Rugama: "Restaurante Rugama è un locale accogliente che apprezza la semplicità e i sapori locali. Anche se poco conosciuto, offre piatti tipici dell'isola: pesce fresco, carne alla griglia e antipasti leggeri fatti in casa.",
          Caretta_Beach_La_Pared: "Caretta Beach La Pared è un ristorante situato sul mare, ideale per chi ama mangiare guardando il tramonto. Il menu propone frutti di mare, pesce alla griglia, insalate e tapas, tutto in un'atmosfera rilassata e vacanziera.",
          La_Jaula_de_Oro: "La Jaula de Oro è un ristorante spagnolo vicino a Pájara, noto per la sua atmosfera accogliente e l'ampia selezione di tapas. Qui si possono gustare antipasti tradizionali, pesce, carne e piatti regionali accompagnati da vino locale.",
          Pez_Gordo: "Pez Gordo, che significa letteralmente 'pesce grosso', è un locale ispirato alla cucina di mare. Il menu include pesce fresco, gamberi, calamari e altri frutti di mare preparati in diversi modi, dalla griglia a stufati delicati.",
          La_Vaca_Azul: "La Vaca Azul è un ristorante in stile griglia che offre eccellenti bistecche, hamburger e piatti di carne. Ci sono anche pesce e snack locali, il tutto servito in un'atmosfera rilassata e amichevole.",
          Olivo_Corso: "Olivo Corso è un elegante ristorante mediterraneo che combina sapori tradizionali con un approccio moderno. Vale la pena provare insalata di polpo, ceviche, tonno e altri piatti di frutti di mare preparati con attenzione ai dettagli.",
          Los_Caracoles: "Los Caracoles è un locale con anima marina, il cui nome – 'le lumache' – fa riferimento agli snack tradizionali spagnoli. Il menu include frutti di mare, tapas e piatti preparati con ingredienti freschi direttamente dal mare.",
          Restaurante_casa_Victor: "Restaurante Casa Victor è un classico ristorante delle Canarie che serve piatti tradizionali spagnoli: pesce, frutti di mare, carne e tapas varie. Un luogo per assaporare il vero gusto dell'isola.",
          Micono: "Micono è un ristorante moderno e informale che offre piatti ispirati alla cucina mediterranea. Qui si possono gustare pesce fresco, insalate, pasta e piatti leggeri ideali per la cena.",
          diner1950: "Diner1950 è un ristorante in stile retro americano, dove dominano hamburger, patatine fritte, milkshake e piatti classici fast-casual. Un luogo con atmosfera nostalgica e rilassata.",
          La_Cofradia: "La Cofradía è un ristorante di carattere marino, spesso gestito da pescatori locali. Il menu si concentra su pesce fresco, gamberi, cozze e piatti preparati in modo semplice e autentico.",
          La_Barraca: "La Barraca è una taverna rustica sul mare che offre piatti semplici e gustosi, dalle tapas al pesce e carne alla griglia. Un luogo ideale per pranzare dopo una giornata in spiaggia.",
          Snack_Bar_Palmita: "Snack Bar Palmita è un piccolo bar che serve spuntini veloci e gustosi. Nel menu ci sono panini, toast, tapas, frutti di mare, pesce, succhi freschi e insalate leggere, perfetto per una sosta veloce durante la giornata.",
          Restaurante_Al_Fresco: "Restaurante Al Fresco è pensato per i pasti all'aperto. Serve piatti mediterranei leggeri: pesce, frutti di mare, pasta e insalate, in un'atmosfera rilassante all'aperto.",
          Leos: "Leo’s è un ristorante accogliente e internazionale, dove è possibile gustare piatti sia della cucina spagnola che europea. Un buon posto per un pranzo rilassato o una cena con vino.",
          El_Gallego_Luis: "El Gallego Luis è un ristorante ispirato alla cucina galiziana, noto per i suoi piatti di frutti di mare. Nel menu ci sono polpo alla gallega, pesce fresco, cozze e antipasti spagnoli classici.",
          Restaurante_Marabu: "Restaurante Marabú è un locale elegante noto per combinare cucina locale e internazionale. Offre piatti stagionali a base di pesce, carne e verdure, oltre a dolci raffinati e una vasta selezione di vini.",
          Casa_Naturaleza: "Casa Naturaleza è un ristorante tranquillo immerso nella natura. Si concentra su cucina sana ed ecologica con ingredienti locali, offrendo piatti vegetariani, insalate, piatti di verdure e succhi naturali.",
          Restaurante_La_Jaira: "Restaurante La Jaira de Demian a Puerto del Rosario è un gastro-bar dove la cucina canaria si unisce a ingredienti locali e stagionali con un approccio moderno. Lo chef crea piatti pieni di texture e colori, come gyoza di barbabietola e formaggio majorero o formaggio al forno con miele di palma. L'interno è elegante, con una grande sala e terrazza; il personale incoraggia a condividere i piatti e godersi insieme la gastronomia dell'isola.",
          Cafe_Caveto: "Café Caveto a La Pared è un caffè-bistrò accogliente con un'atmosfera tranquilla, ideale per colazione, brunch o pranzo leggero. Il menu include dolci fatti in casa, granola, panini e succhi freschi, tutti molto apprezzati dai clienti. Perfetto dopo il surf mattutino o per rilassarsi vicino al mare.",
          Lumos: "Lumos a Corralejo è un ristorante elegante che combina sapori italiani e mediterranei con un approccio moderno. Situato in Calle Hernán Cortés 6, offre panzerotti, pizza e piatti con opzioni vegane e vegetariane. L'interno è accogliente, con terrazza, ideale per una cena tranquilla ma alla moda.",
          Restaurants_description_1: "I ristoranti di Fuerteventura offrono una varietà che soddisfa qualsiasi amante della gastronomia. Al nord troverai gastro-bar moderni e cucina fusion, al centro ristoranti familiari con cucina casalinga e al sud beach bar caratteristici dove dominano pesce fresco e frutti di mare. Prodotti locali come formaggio majorero, pesce appena pescato, olio d'oliva, pomodori maturati al sole ed erbe aromatiche formano la base di una cucina che combina semplicità con profondità di sapore.",
          Restaurants_description_2: "A Fuerteventura, mangiare non è solo soddisfare la fame, ma un vero rituale: un incontro con la natura, la cultura e le persone. In molti luoghi i piatti sono preparati secondo ricette tradizionali tramandate di generazione in generazione, mentre in altri sorprendono con un approccio moderno e presentazioni creative. Che tu scelga una cena elegante con vino, tapas con amici al tramonto o un caffè mattutino con vista sull'oceano, ogni pasto su quest'isola è unico.",
          Food_all: "Tutti",
          Food_fish: "Pesce",
          Food_sea: "Frutti di mare",
          Food_meat: "Carne",
          Food_local: "Locale",
          Food_weg: "Vegetariano",
          Food_pizza: "Pizza",
          Gastrobar_El_Pirata_Verde: "Gastrobar El Pirata Verde è un gastrobar moderno e informale a Fuerteventura con un’atmosfera creativa e rilassata. Offre una fusione di sapori locali e internazionali, con frutti di mare freschi, hamburger gourmet, tapas e opzioni vegetariane, accompagnati da cocktail artigianali e una selezione accurata di bevande.",
      ...
      dk: {
        translation: {
          ...
          youtube_author: "Forfatteren af videoen er",
          Beach_house: "Beach House i Costa Calma er en hyggelig restaurant lige ved stranden. Den serverer italiensk og middelhavsmad: sprøde pizzaer, burger med ost, friske salater, pasta og lette retter, perfekte til varme dage. Et afslappet sted, ideelt til frokost med udsigt over havet.",
          Restaurante_Casa_Isaitas: "Restaurante Casa Isaítas i Pájara ligger i et historisk landhus og tilbyder traditionel kanarisk mad lavet med lokale ingredienser. Menuen inkluderer de berømte cachopo, croquetas, grillet ost, frisk fisk og 'papas arrugadas'. Til dessert serveres hjemmelavet polvito uruguayo.",
          El_Invernadero_Restaurante: "El Invernadero Restaurante er en elegant restaurant kendt for sin moderne middelhavskøkken. Retterne er baseret på frisk fisk, skaldyr og sæsonens produkter, serveret i et stilfuldt og roligt miljø.",
          Restaurante_Rugama: "Restaurante Rugama er et hyggeligt sted, der værdsætter enkelhed og lokale smagsoplevelser. Selvom det er lidt ukendt, tilbyder det typiske retter fra øen: frisk fisk, grillet kød og lette hjemmelavede forretter.",
          Caretta_Beach_La_Pared: "Caretta Beach La Pared er en restaurant lige ved havet, perfekt for dem, der nyder mad med udsigt over solnedgangen. Menuen domineres af skaldyr, grillet fisk, salater og tapas – alt i en afslappet og sommerlig atmosfære.",
          La_Jaula_de_Oro: "La Jaula de Oro er en spansk restaurant i nærheden af Pájara, kendt for sin hyggelige atmosfære og brede udvalg af tapas. Her kan man smage traditionelle snacks, fisk, kød og regionale retter serveret med lokal vin.",
          Pez_Gordo: "Pez Gordo, som bogstaveligt betyder 'stor fisk', er et sted inspireret af havets køkken. Menuen inkluderer frisk fisk, rejer, blæksprutter og andre skaldyr tilberedt på forskellige måder – fra grill til delikate gryderetter.",
          La_Vaca_Azul: "La Vaca Azul er en grillrestaurant, der tilbyder fremragende bøffer, burgere og kødretter. Menuen inkluderer også fisk og lokale snacks, alt serveret i en afslappet og venlig atmosfære.",
          Olivo_Corso: "Olivo Corso er en elegant middelhavsrestaurant, der kombinerer traditionelle smage med en moderne tilgang. Det er værd at prøve blækspruttesalat, ceviche, tun og andre skaldyrsretter lavet med omhu.",
          Los_Caracoles: "Los Caracoles er et sted med maritim sjæl, hvis navn – 'snegle' – henviser til traditionelle spanske snacks. Menuen domineres af skaldyr, tapas og retter lavet af friske ingredienser direkte fra havet.",
          Restaurante_casa_Victor: "Restaurante Casa Victor er en klassisk kanarisk restaurant, der serverer traditionelle spanske retter: fisk, skaldyr, kød og forskellige tapas. Et sted, hvor man kan opleve den ægte smag af øen.",
          Micono: "Micono er en moderne og afslappet restaurant, der tilbyder retter inspireret af middelhavskøkkenet. Her kan man nyde frisk fisk, salater, pasta og lette retter til aftensmaden.",
          diner1950: "Diner1950 er en restaurant i amerikansk retro-stil, hvor burgere, pomfritter, milkshakes og klassiske fast-casual retter dominerer. Et sted med nostalgisk og afslappet atmosfære.",
          La_Cofradia: "La Cofradía er en restaurant med maritim karakter, ofte drevet af lokale fiskere. Menuen fokuserer på frisk fisk, rejer, muslinger og retter tilberedt på en enkel og autentisk måde.",
          La_Barraca: "La Barraca er en rustik taverna ved havet, der tilbyder enkle og velsmagende retter – fra tapas til grillet fisk og kød. Et ideelt sted at spise efter en dag på stranden.",
          Snack_Bar_Palmita: "Snack Bar Palmita er en lille bar, der serverer hurtige og velsmagende snacks. Menuen inkluderer sandwiches, toast, tapas, skaldyr, fisk, friskpressede juicer og lette salater – perfekt til et hurtigt stop i løbet af dagen.",
          Restaurante_Al_Fresco: "Restaurante Al Fresco er designet til udendørs måltider. Serverer lette middelhavsretter: fisk, skaldyr, pasta og salater, i en afslappet atmosfære under åben himmel.",
          Leos: "Leo’s er en hyggelig restaurant med international karakter, hvor man kan nyde både spanske og europæiske retter. Et godt sted til en afslappet frokost eller middag med vin.",
          El_Gallego_Luis: "El Gallego Luis er en restaurant inspireret af galicisk køkken, kendt for sine skaldyrsretter. Menuen inkluderer galicisk blæksprutte, frisk fisk, muslinger og klassiske spanske forretter.",
          Restaurante_Marabu: "Restaurante Marabú er et elegant sted kendt for at kombinere lokal og international mad. Tilbyder sæsonbestemte retter med fisk, kød og grøntsager, samt fine desserter og et bredt udvalg af vine.",
          Casa_Naturaleza: "Casa Naturaleza er en rolig restaurant omgivet af natur. Fokuserer på sund og økologisk mad med lokale ingredienser, tilbyder vegetariske retter, salater, grøntsagsretter og naturlige juicer.",
          Restaurante_La_Jaira: "Restaurante La Jaira de Demian i Puerto del Rosario er en gastro-bar, hvor kanarisk køkken kombineres med moderne tilgang og lokale, sæsonbetonede ingredienser. Køkkenchefen skaber retter fyldt med teksturer og farver – fx gyoza med rødbede og majorero-ost eller bagt ost i palmemel. Interiøret er elegant med stor sal og terrasse, og personalet opfordrer til at dele retterne og nyde øens gastronomi sammen.",
          Cafe_Caveto: "Café Caveto i La Pared er en hyggelig café-bistro med afslappet atmosfære, perfekt til morgenmad, brunch eller let frokost. Menuen inkluderer hjemmebagte kager, granola, sandwiches og friskpresset juice – alt meget positivt bedømt af gæsterne. Ideel efter morgen-surfing eller afslapning ved havet.",
          Lumos: "Lumos i Corralejo er en stilfuld restaurant, der kombinerer italienske og middelhavs smage med moderne tilgang. Beliggende på Calle Hernán Cortés 6, tilbyder panzerotti, pizza og retter med veganske og vegetariske muligheder. Indretningen er venlig, med terrasse, ideel til en rolig men moderne middag.",
          Restaurants_description_1: "Restauranterne på Fuerteventura tilbyder en mangfoldighed, der tilfredsstiller enhver madelsker. I nord finder du moderne gastro-barer og fusion-køkken, i midten familie-restauranter med hjemmelavet mad, og i syd charmerende beach-barer med frisk fisk og skaldyr. Lokale produkter som majorero-ost, friskfanget fisk, olivenolie, solmodne tomater og aromatiske urter udgør grundlaget for en køkkenstil, der kombinerer enkelhed med smagsdybde.",
          Restaurants_description_2: "På Fuerteventura er mad ikke bare for at stille sulten, men en ægte ritual – et møde med natur, kultur og mennesker. Mange steder tilberedes retterne efter traditionelle opskrifter, der går i arv gennem generationer, mens andre overrasker med moderne tilgang og kreativ præsentation. Uanset om du vælger en elegant middag med vin, tapas med venner ved solnedgang eller morgenkaffe med havudsigt – hver måltid på øen smager unikt.",
          Food_all: "Alle",
          Food_fish: "Fisk",
          Food_sea: "Skaldyr",
          Food_meat: "Kød",
          ...
          Food_weg: "Vegetarisk",
          Food_pizza: "Pizza",
          Gastrobar_El_Pirata_Verde: "Gastrobar El Pirata Verde er en afslappet og moderne gastrobar på Fuerteventura med en kreativ og uformel stemning. Den tilbyder en fusion af lokale og internationale smage, herunder frisk fisk og skaldyr, gourmetburgere, tapas samt vegetarvenlige retter, suppleret med håndlavede cocktails og et nøje udvalgt drikkekort.",
